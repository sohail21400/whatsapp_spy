#ONLINE CHECKER WITH XLXS DATABASE
...
#
# user_name = 'Mom'
# workbook = xlsxwriter.Workbook('online_status.xlsx')
...
#
# workbook = xlsxwriter.Workbook('online_status.xlsx')
# worksheet = workbook.add_worksheet('Mom')
#
...
# a = after - now
# print(datetime.timedelta(seconds=a.seconds))

# formated_a = datetime(int(a)).strftime("%H:%M:%S")
# print(a.)